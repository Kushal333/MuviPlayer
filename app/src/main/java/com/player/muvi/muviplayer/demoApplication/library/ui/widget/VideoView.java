...
package com.player.muvi.muviplayer.demoApplication.library.ui.widget;
...
import com.player.muvi.muviplayer.demoApplication.library.ExoMedia;
import com.player.muvi.muviplayer.demoApplication.library.core.ListenerMux;
import com.player.muvi.muviplayer.demoApplication.library.core.api.VideoViewApi;
import com.player.muvi.muviplayer.demoApplication.library.core.exoplayer.ExoMediaPlayer;
import com.player.muvi.muviplayer.demoApplication.library.core.listener.MetadataListener;
import com.player.muvi.muviplayer.demoApplication.library.core.video.exo.ExoTextureVideoView;
import com.player.muvi.muviplayer.demoApplication.library.core.video.mp.NativeTextureVideoView;
import com.player.muvi.muviplayer.demoApplication.library.core.video.scale.ScaleType;
...
public class VideoView extends RelativeLayout {
    ...
    public void setControls(@Nullable VideoControls controls, boolean b) {
    ...
    protected class AttributeContainer {
         ...
         * then the default value from the {@link com.player.muvi.muviplayer.demoApplication.library.core.video.scale.MatrixManager}
         * will be used.
         */
        @Nullable
         ...
         * the default value is different between the {@link com.player.muvi.muviplayer.demoApplication.library.core.video.ResizingSurfaceView}
         * and {@link  com.player.muvi.muviplayer.demoApplication.library.core.video.ResizingTextureView} this will be <code>null</code>
         * when not specified.
         */
        @Nullable
