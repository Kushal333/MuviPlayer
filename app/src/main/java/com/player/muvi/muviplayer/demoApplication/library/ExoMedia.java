package com.player.muvi.muviplayer.demoApplication.library;
...
import com.player.muvi.muviplayer.demoApplication.library.core.source.MediaSourceProvider;
import com.player.muvi.muviplayer.demoApplication.library.core.source.builder.DashMediaSourceBuilder;
import com.player.muvi.muviplayer.demoApplication.library.core.source.builder.HlsMediaSourceBuilder;
import com.player.muvi.muviplayer.demoApplication.library.core.source.builder.SsMediaSourceBuilder;
...
public class ExoMedia {
     ...
     * instances for use with the {@link  com.player.muvi.muviplayer.demoApplication.library.core.source.builder.MediaSourceBuilder}s. This will
     * only be used for builders that haven't customized the {@link  com.player.muvi.muviplayer.demoApplication.library.core.source.builder.MediaSourceBuilder#buildDataSourceFactory(Context, String, TransferListener)}
     * method.
     *
     * @param provider The provider to use for the {@link  com.player.muvi.muviplayer.demoApplication.library.core.source.builder.MediaSourceBuilder}s
     ...
     * used in the {@link  com.player.muvi.muviplayer.demoApplication.library.ui.widget.VideoView} and {@link AudioPlayer}. This allows the
