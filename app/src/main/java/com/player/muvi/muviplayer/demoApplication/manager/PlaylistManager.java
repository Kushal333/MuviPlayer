package com.player.muvi.muviplayer.demoApplication.manager;
...
import com.player.muvi.muviplayer.demoApplication.library.listener.VideoControlsButtonListener;
...
import com.player.muvi.muviplayer.demoApplication.service.MediaService;
...
public class PlaylistManager extends ListPlaylistManager<MediaItem> {
     ...
     * listener provided by ExoMedia's {@link com.player.muvi.muviplayer.demoApplication.library.ui.widget.VideoControls}
     */
